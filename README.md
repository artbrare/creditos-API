...
3. [Endpoints de la API](#endpoints-de-la-api)
    ...
    - [Créditos](#créditos)
        - [Crear un crédito](#crear-un-crdito)
        - [Actualizar un crédito](#actualizar-un-crdito)
        - [Obtener todos los créditos de un cliente](#obtener-todos-los-crditos-de-un-cliente)
        - [Obtener un crédito de un cliente](#obtener-un-crdito-de-un-cliente)
        - [Eliminar un crédito](#eliminar-un-crdito)
